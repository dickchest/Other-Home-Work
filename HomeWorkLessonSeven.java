...
Обьяснение: в переменную n должно записываться случайное (на время тестирования программы) целое число из диапазона от 0 до 28800, далее оно должно выводиться на экран (для тех, кто понимает в секундах) и на следующей строке (для тех кто не понимает) должна выводиться фраза о количестве полных часов, содержащихся в n секундах.
    ...
    public static void main(String[] args) {
        // поиск псевдослучайного числа в диапазоне от 0 до 28800
        int n = (int) Math.round(Math.random()*28800);

        // расчитываем кол-во полных часов, минут и секунд
        int hours = n / 3600;
        int minutes = (n % 3600) / 60;
        int seconds = (n % 60);

        // вывод сообщения в секундах
        System.out.println(n);

        // вывод для тех, кто в танке
        String hoursString = "час";
        if (hours > 4) {
            System.out.printf("осталось %d часов", hours);
        } else if (hours > 1) {
            System.out.printf("осталось %d часа", hours);
        } else if (hours == 1) {
            System.out.printf("остался %d час", hours);
        } else {
            System.out.printf("осталось менее часа");
        }
